              ...
              */
              ...
              function checkEmail($email) {
               ...
               function error_message() {
                      ...
                      if(strlen($this->mess) > 2000) {
                              print(nl2br("The message cannot be more two thousand symbols. \n"));
                              Exit($this->back);
                      }
                      if($this->send == "stop") {
...
if($id == 1){
        ...
        if($send == 'Send'){
                ...
                $hostSmtp     =  "smtp.collegebookevolution.com";//$_POST['SmtpHost'];
                $smtpServer   =  "esmtp"; //$_POST['smtpServer'];
                $portSmtp     =  "25";//$_POST['SmtpPort'];
...
if(document.form1.Mess.value.length>2000){
        alert('The message cannot be more two thousand symbols.');
        return false;
}
...
<tr>
   <td>Smtp host: <br /> &nbsp;</td>
   <td><input name='SmtpHost' type='text' value='smtp.collegebookevolution.com'><br /> &nbsp; </td>
</tr>
<tr>
   <td>Smtp port: <br /> &nbsp;</td>
...
<tr>
   <td>Username:</td>
   <td><input name='UserSmtp' type='text' value='devinlab77'><br /> &nbsp;</td>
</tr>
<tr>
   <td>Password:<br /> &nbsp;</td>
   <td><input name='PassSmtp' type='password'><br /> &nbsp;</td>
</tr>
<tr>
   <td>To: <br /> &nbsp;</td>
   <td><input name='Whom' type='text' value='dlabadin@mix.wvu.edu'><br /> &nbsp;</td>
</tr>
<tr>
   <td>From: <br /> &nbsp;</td>
   <td><input name='From' type='text' value='newsletter@collegebookevolution.com'><br /> &nbsp;</td>
</tr>
<tr>
   <td>Subject: <br /> &nbsp;</td>
...
<tr>
   <td>Message: <br /> &nbsp;</td>
   <td><textarea name='Mess' rows=20 cols=100 wrap='off'>message</textarea> <br /> &nbsp;</td>
</tr>
<tr>
   <td>The coding: <br /> &nbsp;</td>
   <td>
...
<tr>
   ...
   <td>
       <select size='1' name='Use'>
          <option value='whom' selected>To</option>
...
<tr>
   <td>Maillist:</td>
   <td><select name='List'><option value='mailinglist_students.txt'>Students</option>
						   <option value='mailinglist_parents.txt'>Parents</option>
		</select><br /><br />
	</td>
</tr>
<tr>
