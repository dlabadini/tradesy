...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><?php
  ...
  ?><?php
    ...
    { ?><div id="scs_staticcontent_wrapper"><div id="scs_staticcontent"><div id="scs_staticcontent_content"><?php
      ...
      ?></div></div></div><?php } ?><div id="scs_categorieslist"><ul><?php
  ...
  ?><?php
    ...
    if ( 
    $group_name ) 
    { ?><li class="scs_categorieslist_item"><div class="scs_categorieslist_item_inner_wrapper"><a class="scs_categorieslist_link" href="<?php
        echo $group_pagehref;
      ?>"><?php
        echo $group_name;
      ?></a><?php
    ...
    { ?><div class="scs_categorylist_productlist"><ul><?php
    ...
    if ( 
    $product_name ) 
    { ?><li class="scs_categorylist_product"><div class="scs_categorylist_product_inner_wrapper"><a href="<?php
        echo $product_pagehref;
      ?>" class="scs_categorylist_product_link"><?php
        echo $product_name;
      ?></a></div></li><?php } ?><?php } ?></ul></div><?php } ?></div></li><?php } ?><?php } ?></ul></div></div></div></div></div></div></div><div class="scs_cleardiv"><span class="scs_sdkworkaround">&#160;</span></div></div></div></div><div id="scs_footer_area_wrapper"><div id="scs_footer_area_inner_wrapper"><div id="scs_footer_area"><div id="scs_footer_wrapper"><div id="scs_footer_inner_wrapper"><div id="scs_footer"><div class="scs_flat_navmenu"><?php
