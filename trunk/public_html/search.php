...
if($_GET['outersearch'] != "on")
    echo " Click <a href='" . curPageUrl() . "&outersearch=on'>here</a> to retry the search outside your own school.";
echo "</font> <br/><br/><font color='green'>CollegeBookEvolution.com is still gaining popularity, to increase the chance of <br/> finding a match, encourage you friends and classmates to join the eVOLUTION.</font><br/><br/>Reminder, keep your textbooks, list them on CollegeBookEvolution.com :<br/><br/><img src=http://www.collegebookevolution.com/about/compare888.jpg alt='2010 Textbook Price Comparsion'/></center>
";
} else {
