...
//    will be generated (p.e.: emaillist-2ax1zd34rfs.txt), so users will be unable to find it
$file = "../admin/mailinglist_parents.txt";
...
if ($action=="subc"){
        ...
        fclose($cf);
        // notify subscription
        print "Your email has been added to our <b>parents</b> mailing list.<br>Thanks for joining us. <br/><br/>";
}
...
if ($action=="unsubc"){
        ...
        print "Your email has been removed from our <b>parents</b> mailing list.<br>Thanks for joining us. <br/><br/>";
}
...
<table class='sample'width=500px><tr><td>
<div align='center' style='margin-left:10px;'>
<h2>Join our parents mailing list</h2>
<p>
<!-- END OF PAGE LAYOUT -->
